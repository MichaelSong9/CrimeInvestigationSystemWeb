<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewCaseHistoryAdmin.aspx.cs" Inherits="CrimeInvestigationSystemWeb.ViewCaseHistoryAdmin" %>
...
<body>
    ...
    <form id="form1" runat="server" class="container">
        ...
        <div>
            ...
            <br />
            <br />
            <asp:GridView ID="caseHistoryGridView" runat="server" CssClass="table table-bordered table-responsive table-hover">
            </asp:GridView>
