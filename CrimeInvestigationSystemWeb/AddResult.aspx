<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddResult.aspx.cs" Inherits="CrimeInvestigationSystemWeb.AddResult1" %>
...
<body>
    ...
    <form id="form1" runat="server" class="container">
        ...
        <div class="form-horizontal col-xs-5">
            ...
            <div class="form-group">
                <asp:Label ID="Label3" runat="server" Text="Suspects" CssClass="control-label col-md-2"></asp:Label>
                <div class="col-md-10">
                    <asp:DropDownList ID="suspectDropDownList" runat="server" CssClass="form-control">
                    </asp:DropDownList>
                </div>
            </div>
            <div class="form-group">
                <asp:Label ID="Label4" runat="server" Text="Note" CssClass="control-label col-md-2"></asp:Label>
                <div class="col-md-10">
