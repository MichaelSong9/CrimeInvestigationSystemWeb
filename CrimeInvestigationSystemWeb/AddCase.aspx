<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCase.aspx.cs" Inherits="CrimeInvestigationSystemWeb.AddCase1" %>
    ...
    <form id="form1" runat="server" class="container">
        ...
        <div class="form-horizontal col-xs-5">
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <asp:TextBox ID="caseIdTextBox" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <asp:DropDownList ID="officerIdDropDownList" runat="server" CssClass="form-control" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="OfficerId" DataValueField="OfficerId" OnSelectedIndexChanged="officerIdDropDownList_SelectedIndexChanged">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [OfficerId] FROM [AddOfficer]"></asp:SqlDataSource>
